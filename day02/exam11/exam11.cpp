    ...
    case WM_PAINT:
        {
			...
			myBrush = CreateSolidBrush(RGB(255, 204, 204));
			...
			myFont1 = CreateFont(12, 0, 0, 0, 0, 0, 0, 0, HANGUL_CHARSET, 0, 0, 0, 0, L"굴림");
			...
			TextOut(hdc, 320, 170, szMsg, wcslen(szMsg));
			DeleteObject(myFont);
			
			SelectObject(hdc, myFont1);
			TextOut(hdc, 225, 190, szMsg1, wcslen(szMsg1));
			
			SelectObject(hdc, myFont1);
			TextOut(hdc, 270, 210, szMsg2, wcslen(szMsg2));
